...
import za.co.entelect.dojo.utils.ValidationUtils;


public class Track2DataService {

    private static final int CARD_END_INDEX = 17;
    ...
    public boolean isValid(String track2Number) {
        ...
        if(!ValidationUtils.isValidDate(track2Number.substring(MONTH_START, MONTH_END))){
